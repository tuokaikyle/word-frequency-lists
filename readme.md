...
lexique4_5000.tsv was generated by this script: code/lexique4.sql
...
The text from the above 5 links were saved in es/subtitles5k_raw.
They were combined into subtitles5k.txt, using this script: code/combine_spannish.py
